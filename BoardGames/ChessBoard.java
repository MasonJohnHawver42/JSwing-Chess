...
public class ChessBoard extends Board<Chess>
{
    public ChessBoard(Chess game) 
    {
      ...
      */
      ...
      placePiece(new Knight(Chess.dark), 7, 1);
      placePiece(new Knight(Chess.dark), 7, 6);
      placePiece(new Bishop(Chess.dark), 7, 2);
      placePiece(new Bishop(Chess.dark), 7, 5);
      placePiece(new Queen(Chess.dark), 7, 3);
      placePiece(new King(Chess.dark), 7, 4);*/
    }
